...
export const BRANCHES = [
  ...
  },
  {
    id: 2,
    name: 'Akobo Branch',
    address: 'Vitafoam Building, Opp. Akobo Police station',
    area: 'Akobo, Ibadan',
    state: 'Oyo State, Nigeria',
    phone: '+234 815 916 7062',
  ...
  {
    id: 3,
    name: 'Alao Akala Branch',
    address: 'Alao Akala Way, opp. Rccg jesus household',
    area: 'Akobo, Ibadan',
    state: 'Oyo State, Nigeria',
    phone: '+234 815 916 7062',
    ...
    lng: 3.9040,
    isMain: false,
    features: ['Full Service', '24hr Express',],
  },
]