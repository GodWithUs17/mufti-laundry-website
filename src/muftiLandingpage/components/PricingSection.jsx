...
//         // Fetch categories or fallback
//         const categoriesRes = await API.get('/categories').catch(() => API.get('/categories/public'))
//           .catch(() => {
...
//         {/* Header */}
//         <div className={`mx-auto mb-12 max-w-2xl text-center ${inView ? 'animate-slide-up' : 'opacity-0'}`}>
...
//           </h2>
//           <p className="text-lg text-slate-500">Fair prices for premium quality. No hidden charges.</p>
//         </div>
...
//           <button
//             onClick={() => setCat('all')}
//             className={`rounded-xl px-5 py-2.5 text-sm font-semibold transition-all duration-300 ${cat === 'all' ? 'bg-mufti-blue-500 text-white shadow-md' : 'border border-slate-200 bg-white text-slate-600 hover:bg-mufti-blue-50'}`}
//           >
//             All Services
//           </button>
//           {categories.map((c) => (
...
//               key={c.id}
//               onClick={() => setCat(c.id)}
//               className={`rounded-xl px-5 py-2.5 text-sm font-semibold transition-all duration-300 ${cat === c.id ? 'bg-mufti-blue-500 text-white shadow-md' : 'border border-slate-200 bg-white text-slate-600 hover:bg-mufti-blue-50'}`}
//             >
//               {c.label}
//             </button>
//           ))}
...
//             <Icons.Zap className="h-8 w-8 text-mufti-lime-500" />
//             <div>
...
//           </div>
//           <div className="flex items-center gap-4 rounded-2xl bg-white p-6 shadow-sm border border-slate-100">
//             <Icons.Truck className="h-8 w-8 text-mufti-blue-500" />
//             <div>
...
//           </div>
//           <div className="flex items-center gap-4 rounded-2xl bg-white p-6 shadow-sm border border-slate-100">
//             <Icons.RotateCcw className="h-8 w-8 text-green-500" />
//             <div>
